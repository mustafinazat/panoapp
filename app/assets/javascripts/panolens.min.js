var PANOLENS = {
    ...
    enableInlineVideo = function() {
        ...
        function n(t, e, n) {
            function i(i) {
                n && !n(t, e) || i.stopImmediatePropagation()
            }
            return t.addEventListener(e, i), i
        }
        ...
        function i(t, e, n, i) {
            ...
            i && r(t[e]), Object.defineProperty(t, e, {
                get: o,
                set: r
            })
        }
        ...
        function s(t, e, n) {
            (m || 0) + 200 < Date.now() && (t[y] = !0, m = Date.now()), n || (t.currentTime = e), b[++L % 3] = 100 * e | 0
        }
        ...
        function u(t) {
            var e = this,
                n = e[g];
            n.driver.pause(), n.updater.stop(), e.webkitDisplayingFullscreen && e[w](), n.paused && !t || (n.paused = !0, n.hasAudio || r(e, "pause"), e.ended && !e.webkitDisplayingFullscreen && (e[y] = !0, r(e, "ended")))
        }

        function d(t, n) {
            var i = {};
            t[g] = i, i.paused = !0, i.hasAudio = n, i.video = t, i.updater = e(c.bind(i)), n ? i.driver = a(t) : (t.addEventListener("canplay", function() {
                ...
                i.driver.src && i.driver.src !== t.src && (s(t, 0, !0), i.driver.src = t.src, e || !n && t.autoplay ? i.driver.play() : i.updater.stop())
            }, !1), t.addEventListener("webkitbeginfullscreen", function() {
                t.paused ? n && 0 === i.driver.buffered.length && i.driver.load() : (t.pause(), t[N]())
            }), n && (t.addEventListener("webkitendfullscreen", function() {
                i.driver.currentTime = t.currentTime
            }), t.addEventListener("seeking", function() {
                b.indexOf(100 * t.currentTime | 0) < 0 && (i.driver.currentTime = t.currentTime)
            }))
        }
        ...
        function f(t) {
            var e = t[g];
            t[N] = t.play, t[w] = t.pause, t.play = l, t.pause = u, i(t, "paused", e.driver), i(t, "muted", e.driver, !0), i(t, "playbackRate", e.driver, !0), i(t, "ended", e.driver), i(t, "loop", e.driver, !0), n(t, "seeking", function(t) {
                return !t.webkitDisplayingFullscreen
            }), n(t, "seeked", function(t) {
                return !t.webkitDisplayingFullscreen
            }), n(t, "timeupdate", p), n(t, "ended", p)
        }
        ...
        function E(t, e) {
            if (void 0 === e && (e = {}), !t[g]) {
                ...
                t.pause();
                var n = t.autoplay;
                t.autoplay = !1, d(t, !t.muted), f(t), t.classList.add("IIV"), t.muted && n && (t.play(), t.addEventListener("playing", function e() {
...
"undefined" == typeof window && "undefined" != typeof process ? TWEEN.now = function() {
        ...
        this.to = function(t, e) {
            ...
            return c ? (TWEEN.remove(this), c = !1, null !== N && N.call(n, n), this.stopChainedTweens(), this) : this
        }, this.end = function() {
            ...
            var c, N, w;
            if (t < d) return !0;
            !1 === v && (null !== m && m.call(n, n), v = !0), N = (t - d) / a, N = N > 1 ? 1 : N, w = p(N);
            for (c in o)
                if (void 0 !== i[c]) {
                    var b = i[c] || 0,
                        L = o[c];
                    L instanceof Array ? n[c] = f(L, w) : ("string" == typeof L && (L = "+" === L.charAt(0) || "-" === L.charAt(0) ? b + parseFloat(L) : parseFloat(L)), "number" == typeof L && (n[c] = b + (L - b) * w))
                }
            if (null !== g && g.call(n, w), 1 === N) {
                if (s > 0) {
                    isFinite(s) && s--;
                    for (c in r) {
                ...
                null !== y && y.call(n, n);
                for (var A = 0, P = E.length; A < P; A++) E[A].start(d + a);
                return !1
            }
            return !0
        }
        ...
        Bezier: function(t, e) {
            for (var n = 0, i = t.length - 1, o = Math.pow, r = TWEEN.Interpolation.Utils.Bernstein, a = 0; a <= i; a++) n += o(1 - e, i - a) * o(e, a) * t[a] * r(i, a);
            return n
        },
    ...
    function(t) {
        ...
        function o(t) {
            if (j = !1, U = k = 0, !1 !== N.enabled) {
                if (t.preventDefault(), t.button === N.mouseButtons.ORBIT) {
                    if (!0 === N.noRotate) return;
                    F = B.ROTATE, w.set(t.clientX, t.clientY)
                } else if (t.button === N.mouseButtons.ZOOM) {
                    if (!0 === N.noZoom) return;
                    F = B.DOLLY, R.set(t.clientX, t.clientY)
                } else if (t.button === N.mouseButtons.PAN) {
                    if (!0 === N.noPan) return;
                    F = B.PAN, O.set(t.clientX, t.clientY)
                }
                F !== B.NONE && (document.addEventListener("mousemove", r, !1), document.addEventListener("mouseup", a, !1), N.dispatchEvent(X)), N.update()
            }
        }
        ...
        function r(t) {
            if (!1 !== N.enabled) {
                ...
                if (F === B.ROTATE) {
                    if (!0 === N.noRotate) return;
                    b.set(t.clientX, t.clientY), L.subVectors(b, w), N.rotateLeft(2 * Math.PI * L.x / e.clientWidth * N.rotateSpeed), N.rotateUp(2 * Math.PI * L.y / e.clientHeight * N.rotateSpeed), w.copy(b), E && (U = t.clientX - E.clientX, k = t.clientY - E.clientY), E = t
                } else if (F === B.DOLLY) {
                    if (!0 === N.noZoom) return;
                    x.set(t.clientX, t.clientY), M.subVectors(x, R), M.y > 0 ? N.dollyIn() : M.y < 0 && N.dollyOut(), R.copy(x)
                } else if (F === B.PAN) {
                    if (!0 === N.noPan) return;
                    A.set(t.clientX, t.clientY), P.subVectors(A, O), N.pan(P.x, P.y), O.copy(A)
                }
                F !== B.NONE && N.update()
            }
        }
        ...
        function a() {
            j = !0, E = void 0, !1 !== N.enabled && (document.removeEventListener("mousemove", r, !1), document.removeEventListener("mouseup", a, !1), N.dispatchEvent(q), F = B.NONE)
        }

        function s(t) {
            if (!1 !== N.enabled && !0 !== N.noZoom && F === B.NONE) {
        ...
        function c(t) {
            if (!1 !== N.enabled && !0 !== N.noKeys && !0 !== N.noRotate) {
                switch (t.keyCode) {
                    ...
                    case N.keys.RIGHT:
                        y = !0
                }(m || v || g || y) && (j = !0, m && (k = -N.rotateSpeed * N.momentumKeydownFactor), v && (k = N.rotateSpeed * N.momentumKeydownFactor), g && (U = -N.rotateSpeed * N.momentumKeydownFactor), y && (U = N.rotateSpeed * N.momentumKeydownFactor))
            }
        }
        ...
        function l(t) {
            if (j = !1, U = k = 0, !1 !== N.enabled) {
                switch (t.touches.length) {
                    case 1:
                        if (!0 === N.noRotate) return;
                        F = B.TOUCH_ROTATE, w.set(t.touches[0].pageX, t.touches[0].pageY);
                        break;
                    case 2:
                        if (!0 === N.noZoom) return;
                        F = B.TOUCH_DOLLY;
                    ...
                    case 3:
                        if (!0 === N.noPan) return;
                        F = B.TOUCH_PAN, O.set(t.touches[0].pageX, t.touches[0].pageY);
                        break;
                    default:
                        F = B.NONE
                }
                F !== B.NONE && N.dispatchEvent(X)
            }
        }
        ...
        function u(t) {
            if (!1 !== N.enabled) {
                ...
                switch (t.touches.length) {
                    case 1:
                        if (!0 === N.noRotate) return;
                        if (F !== B.TOUCH_ROTATE) return;
                        b.set(t.touches[0].pageX, t.touches[0].pageY), L.subVectors(b, w), N.rotateLeft(2 * Math.PI * L.x / e.clientWidth * N.rotateSpeed), N.rotateUp(2 * Math.PI * L.y / e.clientHeight * N.rotateSpeed), w.copy(b), E && (U = t.touches[0].pageX - E.pageX, k = t.touches[0].pageY - E.pageY), E = {
                    ...
                    case 3:
                        if (!0 === N.noPan) return;
                        if (F !== B.TOUCH_PAN) return;
                        A.set(t.touches[0].pageX, t.touches[0].pageY), P.subVectors(A, O), N.pan(P.x, P.y), O.copy(A), N.update();
                        break;
                    default:
                        F = B.NONE
                }
        ...
        function d() {
            j = !0, E = void 0, !1 !== N.enabled && (N.dispatchEvent(q), F = B.NONE)
        }
        ...
        this.setLastQuaternion = function(t) {
            ...
            var n = N.domElement === document ? N.domElement.body : N.domElement;
            if (N.object instanceof THREE.PerspectiveCamera) {
                var i = N.object.position,
                    o = i.clone().sub(N.target),
                    r = o.length();
                r *= Math.tan(N.object.fov / 2 * Math.PI / 180), N.panLeft(2 * t * r / n.clientHeight), N.panUp(2 * e * r / n.clientHeight)
            } else N.object instanceof THREE.OrthographicCamera ? (N.panLeft(t * (N.object.right - N.object.left) / n.clientWidth), N.panUp(e * (N.object.top - N.object.bottom) / n.clientHeight)) : console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.")
        }, this.momentum = function() {
            if (j) {
                if (Math.abs(U) < 1e-4 && Math.abs(k) < 1e-4) return void(j = !1);
                k *= this.momentumDampingFactor, U *= this.momentumDampingFactor, C -= this.momentumScalingFactor * U, I -= this.momentumScalingFactor * k
            }
        }, this.dollyIn = function(t) {
            void 0 === t && (t = i()), N.object instanceof THREE.PerspectiveCamera ? H /= t : N.object instanceof THREE.OrthographicCamera ? (N.object.zoom = Math.max(this.minZoom, Math.min(this.maxZoom, this.object.zoom * t)), N.object.updateProjectionMatrix(), N.dispatchEvent(Y)) : console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.")
        }, this.dollyOut = function(t) {
            void 0 === t && (t = i()), N.object instanceof THREE.PerspectiveCamera ? H *= t : N.object instanceof THREE.OrthographicCamera ? (N.object.zoom = Math.max(this.minZoom, Math.min(this.maxZoom, this.object.zoom / t)), N.object.updateProjectionMatrix(), N.dispatchEvent(Y)) : console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.")
        }, this.update = function(t) {
            var e = this.object.position;
            T.copy(e).sub(this.target), T.applyQuaternion(W), p = Math.atan2(T.x, T.z), f = Math.atan2(Math.sqrt(T.x * T.x + T.z * T.z), T.y), this.autoRotate && F === B.NONE && this.rotateLeft(n()), this.momentum(), p += C, f += I, p = Math.max(this.minAzimuthAngle, Math.min(this.maxAzimuthAngle, p)), f = Math.max(this.minPolarAngle, Math.min(this.maxPolarAngle, f)), f = Math.max(1e-7, Math.min(Math.PI - 1e-7, f));
            var i = T.length() * H;
            i = Math.max(this.minDistance, Math.min(this.maxDistance, i)), this.target.add(D), T.x = i * Math.sin(f) * Math.sin(p), T.y = i * Math.cos(f), T.z = i * Math.sin(f) * Math.cos(p), T.applyQuaternion(z), e.copy(this.target).add(T), this.object.lookAt(this.target), C = 0, I = 0, H = 1, D.set(0, 0, 0), (V.distanceToSquared(this.object.position) > 1e-7 || 8 * (1 - _.dot(this.object.quaternion)) > 1e-7) && (!0 !== t && this.dispatchEvent(Y), V.copy(this.object.position), _.copy(this.object.quaternion))
        }, this.reset = function() {
            F = B.NONE, this.target.copy(this.target0), this.object.position.copy(this.position0), this.object.zoom = this.zoom0, this.object.updateProjectionMatrix(), this.dispatchEvent(Y), this.update()
        ...
        var h = function(t) {
            ...
            u = function(t) {
                t.preventDefault(), t.stopPropagation(), o += THREE.Math.degToRad((t.touches[0].pageX - a) / 4), r += THREE.Math.degToRad((s - t.touches[0].pageY) / 4), n.updateAlphaOffsetAngle(o), a = t.touches[0].pageX, s = t.touches[0].pageY
            },
            d = function(t, e, i, o, a) {
                ...
                0 == n.screenOrientation ? (s = new THREE.Vector3(1, 0, 0), d.setFromAxisAngle(s, -r)) : 180 == n.screenOrientation ? (s = new THREE.Vector3(1, 0, 0), d.setFromAxisAngle(s, r)) : 90 == n.screenOrientation ? (s = new THREE.Vector3(0, 1, 0), d.setFromAxisAngle(s, r)) : -90 == n.screenOrientation && (s = new THREE.Vector3(0, 1, 0), d.setFromAxisAngle(s, -r)), u.multiply(d), u.multiply(p), c.set(i, e, -o, "YXZ"), t.setFromEuler(c), t.multiply(u), t.multiply(l.setFromAxisAngle(h, -a))
            };
        this.connect = function() {
            c(), window.addEventListener("orientationchange", c, !1), window.addEventListener("deviceorientation", h, !1), window.addEventListener("deviceorientation", this.update.bind(this), !1), n.domElement.addEventListener("touchstart", l, !1), n.domElement.addEventListener("touchmove", u, !1), n.enabled = !0
        }, this.disconnect = function() {
            window.removeEventListener("orientationchange", c, !1), window.removeEventListener("deviceorientation", h, !1), window.removeEventListener("deviceorientation", this.update.bind(this), !1), n.domElement.removeEventListener("touchstart", l, !1), n.domElement.removeEventListener("touchmove", u, !1), n.enabled = !1
        }, this.update = function(t) {
            if (!1 !== n.enabled) {
                var e = n.deviceOrientation.alpha ? THREE.Math.degToRad(n.deviceOrientation.alpha) + this.alphaOffsetAngle : 0,
                    o = n.deviceOrientation.beta ? THREE.Math.degToRad(n.deviceOrientation.beta) : 0,
                    r = n.deviceOrientation.gamma ? THREE.Math.degToRad(n.deviceOrientation.gamma) : 0,
                    a = n.screenOrientation ? THREE.Math.degToRad(n.screenOrientation) : 0;
                d(n.camera.quaternion, e, o, r, a), this.alpha = e, !0 !== t && this.dispatchEvent(i)
            }
        ...
        set: function(t, e, n) {
            return this.direction = new THREE.Vector3, this.direction.copy(t), this.axis = new THREE.Vector3, this.axis.copy(e), this.angle = n, this
        },
        _sign: function(t) {
        ...
        modify: function(t) {
            ...
            for (var i = (new THREE.Matrix4).getInverse(n), o = [], r = [], a = [], s = 0, h = 0, c = 0, l = 0, u = 0; u < t.vertices.length; u++) o[u] = new THREE.Vector3, o[u].copy(t.vertices[u]).applyMatrix4(i), o[u].x > s && (s = o[u].x), o[u].x < h && (h = o[u].x), o[u].y > c && (c = o[u].y), o[u].y < l && (l = o[u].y);
            ...
            for (var N = new THREE.Vector3(0, y.y + y.x / Math.tan(this.angle), 0), u = 0; u < t.vertices.length; u++) {
                var w = 1 * this._sign(r[u].x - E) / f * this._sinhInverse((r[u].x - E) * f),
                    b = 1 / g * this._cosh(g * w) - 1 / g,
                    L = new THREE.Vector3(N.x - w, N.y - (b - p / 2), N.z).normalize(),
                    O = new THREE.Vector3;
                O.addVectors(new THREE.Vector3(w, b - p / 2, r[u].z), L.multiplyScalar(r[u].y + p / 2)), o[u].x = O.x, o[u].y = O.y
            }
            for (var A = E * v / d, u = 0; u < t.vertices.length; u++) {
                var P = new THREE.Vector3(E, m, r[u].z);
                (new THREE.Vector3).subVectors(r[u], P);
                (new THREE.Vector3).subVectors(o[u], P), a[u] = Math.acos(1 / this._cosh(f * o[u].x)) * this._sign(o[u].x), o[u].x = o[u].x + A, t.vertices[u].copy(o[u].applyMatrix4(n))
            }
                ...
                if (void 0 !== x.vertexNormals)
                    for (var M = 0, I = x.vertexNormals.length; M < I; M++) {
                        var C = a[x[S[M]]],
                            ...
                            V = this.axis.z,
                            _ = new THREE.Matrix3;
                        _.set(Math.cos(C) + (1 - Math.cos(C)) * H * H, (1 - Math.cos(C)) * H * D - Math.sin(C) * V, (1 - Math.cos(C)) * H * V + Math.sin(C) * D, (1 - Math.cos(C)) * D * H + Math.sin(C) * V, Math.cos(C) + (1 - Math.cos(C)) * D * D, (1 - Math.cos(C)) * D * V - Math.sin(C) * H, (1 - Math.cos(C)) * V * H - Math.sin(C) * D, (1 - Math.cos(C)) * V * D + Math.sin(C) * H, Math.cos(C) + (1 - Math.cos(C)) * V * V), x.vertexNormals[M].applyMatrix3(_)
                    }
            }
            return this
        }
        ...
        n.add(N), this.setSize = function(e, n) {
            t.setSize(e, n);
            var i = t.getPixelRatio();
            r.setSize(e * i, n * i)
        }, this.render = function(o, a) {
            o.updateMatrixWorld(), null === a.parent && a.updateMatrixWorld(), i.update(a);
            var s = r.width / 2,
                h = r.height;
            r.scissor.set(0, 0, s, h), r.viewport.set(0, 0, s, h), t.render(o, i.cameraL, r), r.scissor.set(s, 0, s, h), r.viewport.set(s, 0, s, h), t.render(o, i.cameraR, r), t.render(n, e)
        }
        ...
        e.aspect = .5, this.setEyeSeparation = function(t) {
            ...
            n.updateMatrixWorld(), null === i.parent && i.updateMatrixWorld(), e.update(i);
            var o = t.getSize();
            t.autoClear && t.clear(), t.setScissorTest(!0), t.setScissor(0, 0, o.width / 2, o.height), t.setViewport(0, 0, o.width / 2, o.height), t.render(n, e.cameraL), t.setScissor(o.width / 2, 0, o.width / 2, o.height), t.setViewport(o.width / 2, 0, o.width / 2, o.height), t.render(n, e.cameraR), t.setScissorTest(!1)
        }
    };
var GSVPANO = GSVPANO || {};
GSVPANO.PanoLoader = function(t) {
        ...
        this.setProgress = function(t, e) {
            ...
            var t = 416 * d[e],
                n = 416 * p[e];
            t = f[e], n = E[e], c = Math.ceil(t / g), l = Math.ceil(n / y), s = [], h = [];
            for (var i = 0, o = 0; o < l; o++)
                for (var r = 0; r < c; r++) {
                    var a = document.createElement("canvas");
                    a.width = r < c - 1 ? g : t - g * r, a.height = o < l - 1 ? y : n - y * o, s.push(a), h.push(a.getContext("2d")), i++
                }
        }, this.composeFromTile = function(t, e, n) {
            t *= 512, e *= 512;
            var i = Math.floor(t / g),
                o = Math.floor(e / y);
            t -= i * g, e -= o * y, h[o * c + i].drawImage(n, 0, 0, n.width, n.height, t, e, 512, 512), this.progress()
        }, this.progress = function() {
            r++;
            Math.round(100 * r / a);
            this.setProgress(r, a), r === a && (this.canvas = s, this.panoId = n, this.zoom = e, this.onPanoramaLoad && this.onPanoramaLoad(s[0]))
        }, this.loadFromId = function(t) {
            n = t, this.composePanorama()
            ...
            var t, o, s, h = d[e],
                ...
                l = this;
            r = 0, a = h * c;
            for (var l = this, s = 0; s < c; s++)
                for (var o = 0; o < h; o++) {
                    var t = "https://geo0.ggpht.com/cbk?cb_client=maps_sv.tactile&authuser=0&hl=en&output=tile&zoom=" + e + "&x=" + o + "&y=" + s + "&panoid=" + n + "&nbt&fover=2";
                    ! function(e, n) {
                        if (i.useWebGL) var o = THREE.ImageUtils.loadTexture(t, null, function() {
                            l.composeFromTile(e, n, o)
                        });
                        else {
                            var r = new Image;
                            r.addEventListener("load", function() {
                                l.composeFromTile(e, n, this)
            ...
            var e = this;
            o.getPanoramaById(t, function(t, i) {
                i === google.maps.StreetViewStatus.OK ? (e.result = t, e.onPanoramaData && e.onPanoramaData(t), u = t.copyright, e.copyright = t.copyright, n = t.location.pano, e.location = location, e.composePanorama()) : (e.onNoPanoramaData && e.onNoPanoramaData(i), e.throwError("Could not retrieve panorama for the following reason: " + i))
            })
    ...
    function() {
        "use strict";
        PANOLENS.Utils.ImageLoader = {}, PANOLENS.Utils.ImageLoader.load = function(t, e, n, i) {
            function o() {
    ...
    function() {
        "use strict";
        PANOLENS.Utils.TextureLoader = {}, PANOLENS.Utils.TextureLoader.load = function(t, e, n, i) {
            var o = new THREE.Texture;
            return PANOLENS.Utils.ImageLoader.load(t, function(t) {
                o.image = t, o.needsUpdate = !0, e && e(o)
            }, n, i), o
        }
    }(),
    function() {
        "use strict";
        PANOLENS.Utils.CubeTextureLoader = {}, PANOLENS.Utils.CubeTextureLoader.load = function(t, e, n, i) {
            var o, r, a, s, h;
    ...
    function() {
        ...
        PANOLENS.Panorama = function(t, e) {
            ...
            t instanceof PANOLENS.Infospot ? (n = t, t.dispatchEvent && (this.container && t.dispatchEvent({
                type: "panolens-container",
                container: this.container
            }), t.dispatchEvent({
                type: "panolens-infospot-focus",
                method: function(t, n, i) {
                    e.dispatchEvent({
            ...
            }))) : (n = new THREE.Object3D, n.scale.x = -1, n.scalePlaceHolder = !0, n.add(t)), THREE.Object3D.prototype.add.call(this, n)
            ...
            e = void 0 !== e ? e : 0;
            var n, i;
            n = this, i = void 0 !== t ? t : !this.isInfospotVisible, this.traverse(function(t) {
                t instanceof PANOLENS.Infospot && (i ? t.show(e) : t.hide(e))
        ...
        }, PANOLENS.Panorama.prototype.link = function(t, e, n, i) {
            var o, r, a, s = this;
            if (this.visible = !0, !e) return void console.warn("Please specify infospot position for linking");
            r = void 0 !== n ? n : void 0 !== t.linkingImageScale ? t.linkingImageScale : 300, a = i || (t.linkingImageURL ? t.linkingImageURL : PANOLENS.DataImage.Arrow), o = new PANOLENS.Infospot(r, a), o.position.copy(e), o.toPanorama = t, o.addEventListener("click", function() {
                s.dispatchEvent({
                    type: "panolens-viewer-handler",
                    method: "setPanorama",
                    data: t
            ...
            function t(e) {
                for (var n = e.children.length - 1; n >= 0; n--) t(e.children[n]), e.remove(e.children[n]);
    ...
    function() {
        ...
        PANOLENS.ImagePanorama = function(t, e) {
            e = e || 5e3;
            var n = new THREE.SphereGeometry(e, 60, 40),
                i = new THREE.MeshBasicMaterial({
                    opacity: 0,
                    transparent: !0
                });
            PANOLENS.Panorama.call(this, n, i), this.src = t
    ...
    function() {
        ...
        PANOLENS.CubePanorama = function(t, e) {
            var n, i, o;
            this.images = t || [], e = e || 1e4, n = JSON.parse(JSON.stringify(THREE.ShaderLib.cube)), i = new THREE.BoxGeometry(e, e, e), o = new THREE.ShaderMaterial({
                fragmentShader: n.fragmentShader,
                vertexShader: n.vertexShader,
                uniforms: n.uniforms,
                side: THREE.BackSide
            }), PANOLENS.Panorama.call(this, i, o)
        ...
        PANOLENS.VideoPanorama = function(t, e, n) {
            ...
            var i = function() {
                n.onProgress({
                    loaded: 1,
                    total: 1
                }), n.setVideoTexture(n.videoElement), n.videoElement.autoplay && n.dispatchEvent({
                    type: "panolens-viewer-handler",
                    method: "updateVideoPlayButton",
                    data: !1
                }), n.isMobile && (n.videoElement.autoplay && n.videoElement.muted ? n.dispatchEvent({
                    type: "panolens-viewer-handler",
                    method: "updateVideoPlayButton",
                    data: !1
                }) : n.dispatchEvent({
            ...
            this.videoElement.readyState > 2 ? i() : (this.videoElement.querySelectorAll("source").length && this.videoElement.src || (this.videoElement.src = t), this.videoElement.load()), this.videoElement.onloadeddata = i, this.videoElement.ontimeupdate = function(t) {
                n.videoProgress = this.duration >= 0 ? this.currentTime / this.duration : 0, n.dispatchEvent({
                    type: "panolens-viewer-handler",
                    method: "onVideoUpdate",
                    data: n.videoProgress
                })
            ...
            var e, n;
            t && (e = new THREE.VideoTexture(t), e.minFilter = THREE.LinearFilter, e.magFilter = THREE.LinearFilter, e.format = THREE.RGBFormat, n = {
                video: t,
                videoTexture: e
            }, this.isIOS && enableInlineVideo(t), this.updateTexture(e), this.videoRenderObject = n)
            ...
            this.videoRenderObject && this.videoRenderObject.video && !Number.isNaN(t.percentage) && 1 !== t.percentage && (this.videoRenderObject.video.currentTime = this.videoRenderObject.video.duration * t.percentage, this.dispatchEvent({
                type: "panolens-viewer-handler",
                method: "onVideoUpdate",
                data: t.percentage
            }))
    ...
    function() {
        ...
        PANOLENS.EmptyPanorama = function(t) {
            ...
            PANOLENS.Panorama.call(this, e, n)
    ...
    function() {
        PANOLENS.LittlePlanet = function(t, e, n, i) {
            ...
            var e = PANOLENS.StereographicShader.uniforms;
            return e.zoom.value = t, new THREE.ShaderMaterial({
                uniforms: e,
            ...
            var e = t.clientX >= 0 ? t.clientX : t.touches[0].clientX,
                n = t.clientY >= 0 ? t.clientY : t.touches[0].clientY;
            switch (t.touches && t.touches.length || 1) {
                case 1:
                    this.dragging = !0, this.userMouse.set(e, n);
                    break;
                case 2:
            ...
            switch (t.touches && t.touches.length || 1) {
                case 1:
                    var i = .4 * THREE.Math.degToRad(e - this.userMouse.x),
                        o = .4 * THREE.Math.degToRad(n - this.userMouse.y);
                    this.dragging && (this.quatA.setFromAxisAngle(this.vectorY, i), this.quatB.setFromAxisAngle(this.vectorX, o), this.quatCur.multiply(this.quatA).multiply(this.quatB), this.userMouse.set(e, n));
                    break;
                case 2:
                    var r = (this.material.uniforms, t.touches[0].pageX - t.touches[1].pageX),
            ...
            var e = this.material.uniforms,
                n = .1 * this.size,
                i = 10 * this.size;
            e.zoom.value += t, e.zoom.value <= n ? e.zoom.value = n : e.zoom.value >= i && (e.zoom.value = i)
    ...
    function() {
        PANOLENS.ImageLittlePlanet = function(t, e, n) {
            PANOLENS.LittlePlanet.call(this, "image", t, e, n)
    ...
    function() {
        PANOLENS.Reticle = function(t, e, n, i, o, r) {
            t = t || 16777215, this.autoSelect = void 0 == e || e, this.dwellTime = o || 1500, this.dwellSpriteAmount = r || 45, this.dwellInterval = this.dwellTime / this.dwellSpriteAmount, this.IDLE = 0, this.DWELLING = 1, this.status, this.scaleIdle = new THREE.Vector3(.2, .2, 1), this.scaleDwell = new THREE.Vector3(1, .8, 1), this.textureLoaded = !1, this.idleImageUrl = n || PANOLENS.DataImage.ReticleIdle, this.dwellImageUrl = i || PANOLENS.DataImage.ReticleDwell, this.idleTexture = new THREE.Texture, this.dwellTexture = new THREE.Texture, THREE.Sprite.call(this, new THREE.SpriteMaterial({
                color: t,
                depthTest: !1
    ...
    function() {
        PANOLENS.Tile = function(t, e, n, i, o, r, a) {
            this.parameters = {
                width: t,
                height: e,
                widthSegments: n,
                ...
                forceAxis: r,
                forceAngle: a
            }, t = t || 10, e = e || 5, n = n || 1, i = i || 1, o = o || new THREE.Vector3(0, 0, 1), r = r || new THREE.Vector3(0, 1, 0), a = void 0 !== a ? a : 0, THREE.Mesh.call(this, new THREE.PlaneGeometry(t, e, n, i), new THREE.MeshBasicMaterial({
                color: 16777215,
                transparent: !0
        ...
        }, PANOLENS.Tile.prototype.bend = function(t, e, n) {
            this.bendModifier.set(t, e, n).modify(this.geometry)
        ...
        }, PANOLENS.Tile.prototype.tween = function(t, e, n, i, o, r, a, s, h) {
            return e = e || this, n = n || {}, i = i || this.animationDuration, o = o || TWEEN.Easing.Exponential.Out, r = void 0 !== r ? r : 0, a = a || null, s = s || null, h = h || null, this.tweens[t] || (this.tweens[t] = new TWEEN.Tween(e).to(n, i).easing(o).delay(r).onStart(a).onUpdate(s).onComplete(h)), this.tweens[t]
        }, PANOLENS.Tile.prototype.ripple = function(t, e, n) {
            t = t || 2, e = e || 200, n = n || TWEEN.Easing.Cubic.Out;
            var i = this,
                o = this.clone();
            new TWEEN.Tween(o.scale).to({
                x: t,
                y: t
            }, e).easing(n).start(), new TWEEN.Tween(o.material).to({
                opacity: 0
            }, e).easing(n).onComplete(function() {
                i.remove(o), o.geometry.dispose(), o.material.dispose()
            }).start(), this.add(o)
    ...
    function() {
        "use strict";
        PANOLENS.TileGroup = function(t, e, n, i, o) {
            var r = this;
            THREE.Object3D.call(this), this.tileArray = t || [], this.offset = void 0 !== o ? o : 0, this.v_gap = void 0 !== e ? e : 6, this.d_gap = void 0 !== n ? n : 2, this.animationDuration = void 0 !== i ? i : 200, this.animationEasing = TWEEN.Easing.Exponential.Out, this.visibleDelta = 2, this.tileArray.map(function(t, e) {
            ...
            var e = this;
            t = t || [], this.children.map(function(n, i) {
                n instanceof PANOLENS.Tile && t[i] && (PANOLENS.Utils.TextureLoader.load(t[i], e.setTexture.bind(n)), n.outline && (n.outline.material.visible = !0))
            })
            ...
            var e, n = this.tileArray;
            if (t = void 0 !== t ? t : this.animationDuration, e = this.offset + 1, this.offset < n.length - 1 && n[this.offset + 1].material.visible) {
                for (var i = n.length - 1; i >= 0; i--) new TWEEN.Tween(n[i].position).to({
                    y: (i - e) * -this.v_gap,
                    z: Math.abs(i - e) * -this.d_gap
            ...
            var e, n = this.tileArray;
            if (t = void 0 !== t ? t : this.animationDuration, e = this.offset - 1, this.offset > 0 && n[this.offset - 1].material.visible) {
                for (var i = 0; i < n.length; i++) new TWEEN.Tween(n[i].position).to({
                    y: (i - e) * -this.v_gap,
                    z: Math.abs(i - e) * -this.d_gap
                }, t).easing(this.animationEasing).start();
                this.offset--, this.updateVisbility(), this.dispatchEvent({
    ...
    function() {
        "use strict";
        var t, e, n = [];
        PANOLENS.SpriteText = function(t, e, n, i, o) {
            THREE.Object3D.call(this), this.text = t || "", this.maxWidth = e || 2e3, this.color = n || 16777215, this.opacity = void 0 !== i ? i : 1, this.options = o || {}, this.animationDuration = 500, this.animationFadeOut = void 0, this.animationFadeIn = void 0, this.tweens = {}, this.addText(t)
            ...
            r.needsUpdate = !0, r.minFilter = THREE.LinearMipMapLinearFilter, r.magFilter = THREE.LinearFilter, r.generateMipmaps = !0, r.anisotropy = 8, t = o, e = r;
            for (var a = n.length - 1; a >= 0; a--) n[a].target.addText(n[a].text);
            for (; n.length > 0;) n.pop();
            i && i()
        }, PANOLENS.SpriteText.prototype.addText = function(i) {
            if (!t || !e) return void n.push({
                target: this,
                text: i
            });
            var o = new THREE.Object3D;
            this.options.text = i, this.options.font = t, this.options.width = this.maxWidth;
        ...
        }, PANOLENS.SpriteText.prototype.tween = function(t, e, n, i, o, r, a, s, h) {
            return e = e || this, n = n || {}, i = i || this.animationDuration, o = o || TWEEN.Easing.Exponential.Out, r = void 0 !== r ? r : 0, a = a || null, s = s || null, h = h || null, this.tweens[t] || (this.tweens[t] = new TWEEN.Tween(e).to(n, i).easing(o).delay(r).onStart(a).onUpdate(s).onComplete(h)), this.tweens[t]
    ...
    function() {
        PANOLENS.Widget = function(t) {
            ...
            var t, e, n, i, o = this;
            i = "linear-gradient(bottom, rgba(0,0,0,0.2), rgba(0,0,0,0))", t = document.createElement("div"), t.style.width = "100%", t.style.height = "44px", t.style.float = "left", t.style.transform = t.style.webkitTransform = t.style.msTransform = "translateY(-100%)", t.style.background = "-webkit-" + i, t.style.background = "-moz-" + i, t.style.background = "-o-" + i, t.style.background = "-ms-" + i, t.style.background = i, t.style.transition = this.DEFAULT_TRANSITION, t.style.pointerEvents = "none", t.isHidden = !1, t.toggle = function() {
                t.isHidden = !t.isHidden, e = t.isHidden ? "translateY(0)" : "translateY(-100%)", n = t.isHidden ? 0 : 1, t.style.transform = t.style.webkitTransform = t.style.msTransform = e, t.style.opacity = n
            };
            ...
            function t(t) {
                t.preventDefault(), t.stopPropagation(), n.mainMenu.toggle(), this.activated ? this.deactivate() : this.activate()
            }
            var e, n = this;
            ...
            function e(t) {
                a && (r = !r, n.style.backgroundImage = r ? 'url("' + PANOLENS.DataImage.FullscreenLeave + '")' : 'url("' + PANOLENS.DataImage.FullscreenEnter + '")'), o.dispatchEvent({
                    type: "panolens-viewer-handler",
            ...
            var n, i, o = this,
                r = !1,
                a = !0;
            if (i = "panolens-style-addon", document.fullscreenEnabled || document.webkitFullscreenEnabled || document.mozFullScreenEnabled || document.msFullscreenEnabled) {
                if (document.addEventListener("fullscreenchange", e, !1), document.addEventListener("webkitfullscreenchange", e, !1), document.addEventListener("mozfullscreenchange", e, !1), document.addEventListener("MSFullscreenChange", e, !1), n = this.createCustomItem({
                        style: {
                    ...
                    s.id = i, s.innerHTML = ":-webkit-full-screen { width: 100% !important; height: 100% !important }", document.body.appendChild(s)
                }
                return n
            }
            ...
            function t(t) {
                t.preventDefault(), t.stopPropagation(), n.dispatchEvent({
                    type: "panolens-viewer-handler",
            ...
            function t(t) {
                t.stopPropagation(), f = !0, l = t.clientX || t.changedTouches && t.changedTouches[0].clientX, u = parseInt(h.style.width) / 100, i()
            }
            ...
            function i() {
                p.container.addEventListener("mousemove", e, !1), p.container.addEventListener("mouseup", n, !1), p.container.addEventListener("touchmove", e, !1), p.container.addEventListener("touchend", n, !1)
            }

            function o() {
                p.container.removeEventListener("mousemove", e, !1), p.container.removeEventListener("mouseup", n, !1), p.container.removeEventListener("touchmove", e, !1), p.container.removeEventListener("touchend", n, !1)
            }
            ...
            return n.textContent = t, n.style.display = "block", n.style.padding = "10px", n.style.textDecoration = "none", n.style.cursor = "pointer", n.style.pointerEvents = "auto", n.style.transition = this.DEFAULT_TRANSITION, n.slide = function(t) {
                this.style.transform = "translateX(" + (t ? "" : "-") + "100%)"
            }, n.unslide = function() {
                this.style.transform = "translateX(0)"
            }, n.setIcon = function(t) {
                this.icon && (this.icon.style.backgroundImage = "url(" + t + ")")
            }, n.setSelectionTitle = function(t) {
                this.selection && (this.selection.textContent = t)
            }, n.addSelection = function(t) {
            ...
            }, n.addIcon = function(t, e, n) {
                t = t || PANOLENS.DataImage.ChevronRight, e = e || !1, n = n || !1;
                var i = document.createElement("span");
                return i.style.float = e ? "left" : "right", i.style.width = "17px", i.style.height = "17px", i.style["margin" + (e ? "Right" : "Left")] = "12px", i.style.backgroundSize = "cover", n && (i.style.transform = "rotateZ(180deg)"), this.icon = i, this.setIcon(t), this.appendChild(i), this
            }, n.addSubMenu = function(t, n) {
                return this.subMenu = e.createSubMenu(t, n), this
            ...
            function e(t) {
                function e() {
                    i.changeSize(o.clientWidth), o.show(), o.unslideAll()
                }
                t.preventDefault(), t.stopPropagation();
                var i = n.mainMenu,
                    o = this.subMenu;
                i.hide(), i.slideAll(), i.parentElement.appendChild(o), n.activeMainItem = this, n.activeSubMenu = o, window.requestAnimationFrame(e)
            }
            var n = this,
                i = this.createMenu();
            i._width = 200, i.changeSize(i._width);
            for (var o = 0; o < t.length; o++) {
                var r = i.addItem(t[o].title);
                if (r.style.paddingLeft = "20px", r.addIcon().addEventListener(n.TOUCH_ENABLED ? "touchend" : "click", e, !1), t[o].subMenu && t[o].subMenu.length > 0) {
            ...
            function n(t) {
                t.preventDefault(), t.stopPropagation(), i = o.mainMenu, i.changeSize(i._width), i.unslideAll(), i.show(), r.slideAll(!0), r.hide(), "header" !== this.type && (r.setActiveItem(this), o.activeMainItem.setSelectionTitle(this.textContent), this.handler && this.handler())
            }
            var i, o = this,
                r = this.createMenu();
            r.items = e, r.activeItem, r.addHeader(t).addIcon(void 0, !0, !0).addEventListener(o.TOUCH_ENABLED ? "touchend" : "click", n, !1);
            for (var a = 0; a < e.length; a++) {
                var s = r.addItem(e[a].title);
                s.style.fontWeight = 300, s.handler = e[a].handler, s.addIcon(" ", !0), s.addEventListener(o.TOUCH_ENABLED ? "touchend" : "click", n, !1), r.activeItem || r.setActiveItem(s)
            }
            return r.slideAll(!0), r
        }, PANOLENS.Widget.prototype.createMenu = function() {
            var t, e = this,
                n = document.createElement("span");
            return t = n.style, t.padding = "5px 0", t.position = "fixed", t.bottom = "100%", t.right = "14px", t.backgroundColor = "#fafafa", t.fontFamily = "Helvetica Neue", t.fontSize = "14px", t.visibility = "hidden", t.opacity = 0, t.boxShadow = "0 0 12pt rgba(0,0,0,0.25)", t.borderRadius = "2px", t.overflow = "hidden", t.willChange = "width, height, opacity", t.pointerEvents = "auto", t.transition = this.DEFAULT_TRANSITION, n.visible = !1, n.changeSize = function(t, e) {
            ...
            }, n.slideAll = function(t) {
                for (var e = 0; e < n.children.length; e++) n.children[e].slide && n.children[e].slide(t)
            }, n.unslideAll = function() {
                for (var t = 0; t < n.children.length; t++) n.children[t].unslide && n.children[t].unslide()
            }, n.addHeader = function(t) {
                var n = e.createMenuItemHeader(t);
                return n.type = "header", this.appendChild(n), n
            }, n.addItem = function(t) {
                var n = e.createMenuItem(t);
            ...
            t = t || {};
            var e = this,
                n = t.element || document.createElement("span");
            ...
            }), n.addEventListener(e.TOUCH_ENABLED ? "touchend" : "mouseleave", function() {
                n.style.filter = n.style.webkitFilter = ""
            }), n = this.mergeStyleOptions(n, t.style), t.onTap && n.addEventListener(e.TOUCH_ENABLED ? "touchend" : "click", t.onTap, !1), n.dispose = function() {
                n.removeEventListener(e.TOUCH_ENABLED ? "touchend" : "click", t.onTap, !1), t.onDispose && t.onDispose()
            }, n
    ...
    function() {
        PANOLENS.Infospot = function(t, e, n) {
            function i(e) {
            ...
            var a, s, h, c = this;
            t = t || 300, e = e || PANOLENS.DataImage.Info, h = 500, THREE.Sprite.call(this), this.type = "infospot", this.animated = void 0 === n || n, this.isHovering = !1, this.visible = !1, this.element, this.toPanorama, this.cursorStyle, this.mode = PANOLENS.Modes.UNKNOWN, this.scale.set(t, t, 1), this.rotation.y = Math.PI, this.scaleFactor = 1.3, this.container, this.HANDLER_FOCUS, PANOLENS.Utils.TextureLoader.load(e, i), this.showAnimation = new TWEEN.Tween(this.material).to({
                opacity: 1
            ...
            this.getContainer() && (this.isHovering = !1, this.container.style.cursor = "default", this.animated && (this.scaleUpAnimation && this.scaleUpAnimation.stop(), this.scaleDownAnimation && this.scaleDownAnimation.start()), this.element && !this.element.locked && (this.element.style.display = "none", this.element.left && (this.element.left.style.display = "none"), this.element.right && (this.element.right.style.display = "none"), this.lockHoverElement()))
        }, PANOLENS.Infospot.prototype.onDualEyeEffect = function(t) {
            if (this.getContainer()) {
                var e, n, i;
                this.mode = t.mode, e = this.element, n = this.container.clientWidth / 2, i = this.container.clientHeight / 2, e && (e.left && e.right || (e.left = e.cloneNode(!0), e.right = e.cloneNode(!0)), this.mode === PANOLENS.Modes.CARDBOARD || this.mode === PANOLENS.Modes.STEREO ? (e.left.style.display = e.style.display, e.right.style.display = e.style.display, e.style.display = "none") : (e.style.display = e.left.style.display, e.left.style.display = "none", e.right.style.display = "none"), this.translateElement(n, i), this.container.appendChild(e.left), this.container.appendChild(e.right))
            }
        }, PANOLENS.Infospot.prototype.translateElement = function(t, e) {
            if (this.element._width && this.element._height && this.getContainer()) {
                var n, i, o, r, a, s, h;
                h = this.container, o = this.element, r = o._width / 2, a = o._height / 2, s = void 0 !== o.verticalDelta ? o.verticalDelta : 40, n = t - r, i = e - a - s, this.mode !== PANOLENS.Modes.CARDBOARD && this.mode !== PANOLENS.Modes.STEREO || !o.left || !o.right || t === h.clientWidth / 2 && e === h.clientHeight / 2 ? this.setElementStyle("transform", o, "translate(" + n + "px, " + i + "px)") : (n = h.clientWidth / 4 - r + (t - h.clientWidth / 2), i = h.clientHeight / 2 - a - s + (e - h.clientHeight / 2), this.setElementStyle("transform", o.left, "translate(" + n + "px, " + i + "px)"), n += h.clientWidth / 2, this.setElementStyle("transform", o.right, "translate(" + n + "px, " + i + "px)"))
            }
        }, PANOLENS.Infospot.prototype.setElementStyle = function(t, e, n) {
            var i = e.style;
            "transform" === t && (i.webkitTransform = i.msTransform = i.transform = n)
            ...
            t = t || 0, this.animated && (this.hideAnimation && this.hideAnimation.stop(), this.showAnimation && this.showAnimation.delay(t).start())
        }, PANOLENS.Infospot.prototype.hide = function(t) {
            t = t || 0, this.animated && (this.showAnimation && this.showAnimation.stop(), this.hideAnimation && this.hideAnimation.delay(t).start())
    ...
    function() {
        ...
        PANOLENS.Viewer = function(t) {
                ...
                if ("panorama" === t.type && e !== t) {
                    this.hideInfospot();
                    var n = function() {
                        e && e.onLeave(), t.removeEventListener("enter-fade-start", n)
                    };
                    t.addEventListener("enter-fade-start", n), (this.panorama = t).onEnter()
                }
                ...
                var n, i = this.widget.mainMenu,
                    o = i.children[0],
                    r = i.children[1];
                if (void 0 !== t) {
                    switch (t) {
                        case 0:
                            n = o.subMenu.children[1];
                            break;
                        case 1:
                            n = o.subMenu.children[2];
                            break;
                        default:
                            n = o.subMenu.children[1]
                    }
                    o.subMenu.setActiveItem(n), o.setSelectionTitle(n.textContent)
                }
                if (void 0 !== e) {
                    switch (e) {
                        case PANOLENS.Modes.CARDBOARD:
                            n = r.subMenu.children[2];
                            break;
                        case PANOLENS.Modes.STEREO:
                            n = r.subMenu.children[3];
                            break;
                        default:
                            n = r.subMenu.children[1]
                    }
                    r.subMenu.setActiveItem(n), r.setSelectionTitle(n.textContent)
                }
                ...
                this.reticle.visible || (this.reticle.textureLoaded || this.reticle.loadTextures(), this.tempEnableReticle = !0, this.unregisterMouseAndTouchEvents(), this.reticle.show(), this.registerReticleEvent(), this.updateReticleEvent())
            ...
            PANOLENS.Viewer.prototype.addUpdateCallback = function(t) {
                ...
                var t, e, n;
                return t = this.controls, e = this.control, n = t.indexOf(e) + 1, n >= t.length ? 0 : n
                ...
                return e.project(this.camera), e.x = e.x * n + n, e.y = -e.y * i + i, e.z = 0, e
            ...
            }, PANOLENS.Viewer.prototype.tweenControlCenter = function(t, e, n) {
                if (this.control === this.OrbitControls) {
                    t instanceof Array && (e = t[1], n = t[2], t = t[0]), e = void 0 !== e ? e : 1e3, n = n || TWEEN.Easing.Exponential.Out;
                    var i, o, r, a, s, h, c, l, u, d;
                    i = this, a = this.camera.getWorldDirection(), s = a.clone(), l = this.panorama.getWorldPosition().sub(this.camera.getWorldPosition()), h = t.clone(), h.x *= -1, h.add(l).normalize(), c = h.clone(), a.y = 0, h.y = 0, o = Math.atan2(h.z, h.x) - Math.atan2(a.z, a.x), o = o > Math.PI ? o - 2 * Math.PI : o, o = o < -Math.PI ? o + 2 * Math.PI : o, r = Math.abs(s.angleTo(a) + (s.y * c.y <= 0 ? c.angleTo(h) : -c.angleTo(h))), r *= c.y < s.y ? 1 : -1, u = {
                        left: 0,
                        up: 0
                    }, d = {
                        left: 0,
                ...
                t.preventDefault(), this.userMouse.x = t.clientX >= 0 ? t.clientX : t.touches[0].clientX, this.userMouse.y = t.clientY >= 0 ? t.clientY : t.touches[0].clientY, this.userMouse.type = "mousedown"
            }, PANOLENS.Viewer.prototype.onMouseMove = function(t) {
                t.preventDefault(), this.userMouse.type = "mousemove"
                ...
                }, e) : this.onTap(t, e), this.userMouse.type = "none", n || "click" === e && (this.options.autoHideInfospot && this.panorama && this.panorama.toggleInfospotVisibility(), this.options.autoHideControlBar && this.toggleControlBar()))
            }, PANOLENS.Viewer.prototype.onTap = function(t, e) {
                var n, i, o;
                if (this.raycasterPoint.x = (t.clientX - this.container.getBoundingClientRect().left) / this.container.clientWidth * 2 - 1, this.raycasterPoint.y = -(t.clientY - this.container.getBoundingClientRect().top) / this.container.clientHeight * 2 + 1, this.raycaster.setFromCamera(this.raycasterPoint, this.camera), this.panorama)
                    if (("mousedown" !== t.type && PANOLENS.Utils.checkTouchSupported() || this.OUTPUT_INFOSPOT) && this.outputInfospotPosition(), n = this.raycaster.intersectObjects(this.panorama.children, !0), i = this.getConvertedIntersect(n), o = n.length > 0 ? n[0].object : o, "mouseup" === this.userMouse.type && (i && this.pressEntityObject === i && this.pressEntityObject.dispatchEvent && this.pressEntityObject.dispatchEvent({
                            ...
                            type: "pressstop",
                            mouseEvent: t
                        }), this.pressObject = void 0), "cl1ick" === e ? (this.panorama.dispatchEvent({
                            type: "cl1ick",
                            intersects: n,
                            mouseEvent: t
                        }), i && i.dispatchEvent && i.dispatchEvent({
                            type: "cl1ick-entity",
                            mouseEvent: t
                            ...
                            intersects: n,
                            mouseEvent: t
                        }), (this.hoverObject && n.length > 0 && this.hoverObject !== i || this.hoverObject && 0 === n.length) && (this.hoverObject.dispatchEvent && (this.hoverObject.dispatchEvent({
                            type: "hoverleave",
                            mouseEvent: t
                        }), this.reticle.cancelDwelling()), this.hoverObject = void 0), i && n.length > 0 && (this.hoverObject !== i && (this.hoverObject = i, this.hoverObject.dispatchEvent && (this.hoverObject.dispatchEvent({
                            type: "hoverenter",
                            mouseEvent: t
                        }), (this.options.autoReticleSelect && this.options.enableReticle || this.tempEnableReticle) && this.reticle.startDwelling(this.onTap.bind(this, t, "click")))), "mousedown" === this.userMouse.type && this.pressEntityObject != i && (this.pressEntityObject = i, this.pressEntityObject.dispatchEvent && this.pressEntityObject.dispatchEvent({
                            ...
                            type: "pressmove",
                            mouseEvent: t
                        }))), !i && this.pressEntityObject && this.pressEntityObject.dispatchEvent && (this.pressEntityObject.dispatchEvent({
                            type: "pressstop-entity",
                            mouseEvent: t
                ...
                for (var e, n = 0; n < t.length; n++)
                    if (t[n].distance >= 0 && t[n].object && !t[n].object.passThrough) {
                        if (t[n].object.entity && t[n].object.entity.passThrough) continue;
                        if (t[n].object.entity && !t[n].object.entity.passThrough) {
                            e = t[n].object.entity;
                            break
                        }
                        e = t[n].object;
                ...
                function t(t) {
                    if (0 !== t.loaded) {
                        var n = t.target.responseXML.documentElement;
                        n.style.width = e.viewIndicatorSize + "px", n.style.height = e.viewIndicatorSize + "px", n.style.position = "absolute", n.style.top = "10px", n.style.left = "10px", n.style.opacity = "0.5", n.style.cursor = "pointer", n.id = "panolens-view-indicator-container", e.container.appendChild(n);
                        var i = n.querySelector("#indicator"),
                            o = function() {
    ...
    function t(e, n, i) {
        ...
        1: [function(t, e, n) {
            ...
            e.exports = function(t) {
                return new i(t)
            }, r(i, u), i.prototype.update = function(t) {
            ...
            }, i.prototype.computeBoundingSphere = function() {
        ...
        2: [function(t, e, n) {
            function i(t) {
                ...
                for (var n = 0; n < e; n++) {
                    var i = t[n * o + 0],
                        a = t[n * o + 1];
                    r.min[0] = Math.min(i, r.min[0]), r.min[1] = Math.min(a, r.min[1]), r.max[0] = Math.max(i, r.max[0]), r.max[1] = Math.max(a, r.max[1])
                }
            }
            var o = 2,
                r = {
            ...
            e.exports.computeBox = function(t, e) {
                i(t), e.min.set(r.min[0], r.min[1], 0), e.max.set(r.max[0], r.max[1], 0)
                ...
                var n = r.min[0],
                    ...
                    c = s - o,
                    l = Math.sqrt(h * h + c * c);
                e.center.set(n + h / 2, o + c / 2, 0), e.radius = l / 2
            }
        }, {}],
        3: [function(t, e, n) {
            e.exports.pages = function(t) {
            ...
            }, e.exports.uvs = function(t, e, n, i) {
                ...
                return t.forEach(function(t) {
                    var a = t.data,
                        ...
                        u = s / e,
                        d = h / n;
                    i && (l = (n - a.y) / n, d = (n - h) / n), o[r++] = c, o[r++] = l, o[r++] = c, o[r++] = d, o[r++] = u, o[r++] = d, o[r++] = u, o[r++] = l
                }), o
                ...
                return t.forEach(function(t) {
                    var i = t.data,
                        o = t.position[0] + i.xoffset,
                        r = t.position[1] + i.yoffset,
                        a = i.width,
                        s = i.height;
                    e[n++] = o, e[n++] = r, e[n++] = o, e[n++] = r + s, e[n++] = o + a, e[n++] = r + s, e[n++] = o + a, e[n++] = r
                }), e
            }
        }, {}],
        4: [function(t, e, n) {
        ...
        5: [function(t, e, n) {
            ...
            function s(t) {
                for (var e = 0; e < m.length; e++) {
                    var n = m[e].charCodeAt(0),
                        i = f(t.chars, n);
                    if (i >= 0) return t.chars[i].height
                }
                return 0
            }
            ...
            function h(t) {
                for (var e = 0; e < v.length; e++) {
                    var n = v[e].charCodeAt(0),
                        i = f(t.chars, n);
                    if (i >= 0) return t.chars[i]
                }
                return 0
            }
            ...
            function l(t, e, n) {
                ...
                for (var i = t.kernings, o = 0; o < i.length; o++) {
                    var r = i[o];
            ...
            e.exports = function(t) {
                ...
                var a = o.reduce(function(t, e) {
                    ...
                    h = 0,
                    f = 0,
                    m = E(t.lineHeight, i.common.lineHeight),
                    v = i.common.base,
                    g = m - v,
                    y = t.letterSpacing || 0,
                    N = m * o.length - g,
                    w = u(this._opt.align);
                f -= N, this._width = a, this._height = N, this._descender = m - v, this._baseline = v, this._xHeight = s(i), this._capHeight = c(i), this._lineHeight = m, this._ascender = m - g - this._xHeight;
                var O = this;
            ...
            }, i.prototype._setupSpaceGlyphs = function(t) {
            ...
            }, i.prototype.getGlyph = function(t, e) {
                var n = a(t, e);
                return n || (e === y ? this._fallbackTabGlyph : e === N ? this._fallbackSpaceGlyph : null)
            }, i.prototype.computeMetrics = function(t, e, n, i) {
        ...
        8: [function(t, e, n) {
            ...
            function r(t, e, n, i, o) {
                for (var r = [], a = n, s = n; s < i && s < e.length; s++) {
                    var c = e.charAt(s),
                        l = h.test(c);
                    if (l || s === i - 1) {
                        var u = l ? s : s + 1,
            ...
            function a(t, e, n, r, a, s) {
                var h = [],
                    l = a;
                for ("nowrap" === s && (l = Number.MAX_VALUE); n < r && n < e.length;) {
                    for (var u = i(e, c, n, r); n < u && o(e.charAt(n));) n++;
                    var d = t(e, n, u, l),
                        p = n + (d.end - d.start),
                        f = p + c.length;
                    if (p < u) {
                        for (; p > n && !o(e.charAt(p));) p--;
                        if (p === n) f > n + c.length && f--, p = f;
                        else
                            for (f = p; p > n && o(e.charAt(p - c.length));) p--
                    }
                    if (p >= n) {
                        var E = t(e, n, p, l);
                        h.push(E)
            ...
            e.exports = function(t, n) {
                ...
                var n = "number" == typeof e.width ? e.width : Number.MAX_VALUE,
                    i = Math.max(0, e.start || 0),
                    o = "number" == typeof e.end ? e.end : t.length,
                    h = e.mode,
                    c = e.measure || s;
                return "pre" === h ? r(c, t, i, o, n) : a(c, t, i, o, n, h)
            }
        }, {}],
        9: [function(t, e, n) {
            function i() {
            ...
            (function(n) {
                ...
                e.exports = function(t, e) {
                    e = "function" == typeof e ? e : a, "string" == typeof t ? t = {
                        ...
                        l(u) && (d = !0, "string" == typeof u && (u = new n(u, "binary"))), d || (n.isBuffer(u) && (u = u.toString(t.encoding)), u = u.trim());
                        var f;
                        try {
        ...
        11: [function(t, e, n) {
            (function(n) {
                var i = t("buffer-equal"),
                    o = new n([66, 77, 70, 3]);
                e.exports = function(t) {
                    return "string" == typeof t ? "BMF" === t.substring(0, 3) : t.length > 4 && i(t.slice(0, 4), o)
                }
            }).call(this, t("buffer").Buffer)
        }, {
            buffer: 37,
        ...
        13: [function(t, e, n) {
            function i(t, e) {
                ...
                t = t.substring(n + 1), t = t.replace(/letter=[\'\"]\S+[\'\"]/gi, ""), t = t.split("="), t = t.map(function(t) {
        ...
        14: [function(t, e, n) {
            ...
            function o(t, e) {
                ...
                return n.smooth = i >> 7 & 1, n.unicode = i >> 6 & 1, n.italic = i >> 5 & 1, n.bold = i >> 4 & 1, i >> 3 & 1 && (n.fixedHeight = 1), n.charset = t.readUInt8(e + 3) || "", n.stretchH = t.readUInt16LE(e + 4), n.aa = t.readUInt8(e + 6), n.padding = [t.readInt8(e + 7), t.readInt8(e + 8), t.readInt8(e + 9), t.readInt8(e + 10)], n.spacing = [t.readInt8(e + 11), t.readInt8(e + 12)], n.outline = t.readUInt8(e + 13), n.face = l(t, e + 14), n
            }

            function r(t, e) {
                var n = {};
                n.lineHeight = t.readUInt16LE(e), n.base = t.readUInt16LE(e + 2), n.scaleW = t.readUInt16LE(e + 4), n.scaleH = t.readUInt16LE(e + 6), n.pages = t.readUInt16LE(e + 8);
                t.readUInt8(e + 10);
                return n.packed = 0, n.alphaChnl = t.readUInt8(e + 11), n.redChnl = t.readUInt8(e + 12), n.greenChnl = t.readUInt8(e + 13), n.blueChnl = t.readUInt8(e + 14), n
            }

            function a(t, e, n) {
                for (var i = [], o = c(t, e), r = o.length + 1, a = n / r, s = 0; s < a; s++) i[s] = t.slice(e, e + o.length).toString("utf8"), e += r;
                return i
            }

            function s(t, e, n) {
                for (var i = [], o = n / 20, r = 0; r < o; r++) {
                    var a = {},
                        s = 20 * r;
                    a.id = t.readUInt32LE(e + 0 + s), a.x = t.readUInt16LE(e + 4 + s), a.y = t.readUInt16LE(e + 6 + s), a.width = t.readUInt16LE(e + 8 + s), a.height = t.readUInt16LE(e + 10 + s), a.xoffset = t.readInt16LE(e + 12 + s), a.yoffset = t.readInt16LE(e + 14 + s), a.xadvance = t.readInt16LE(e + 16 + s), a.page = t.readUInt8(e + 18 + s), a.chnl = t.readUInt8(e + 19 + s), i[r] = a
                }
                return i
            }

            function h(t, e, n) {
                for (var i = [], o = n / 10, r = 0; r < o; r++) {
                    var a = {},
                        s = 10 * r;
                    a.first = t.readUInt32LE(e + 0 + s), a.second = t.readUInt32LE(e + 4 + s), a.amount = t.readInt16LE(e + 8 + s), i[r] = a
                }
                return i
            }
        ...
        15: [function(t, e, n) {
            ...
            function o(t) {
                for (var e = [], n = 0; n < t.attributes.length; n++) e.push(t.attributes[n]);
                return e
            }
        ...
        16: [function(t, e, n) {
            ...
            e.exports = function(t) {
                ...
                for (var e in t) "face" !== e && "charset" !== e && (t[e] = "padding" === e || "spacing" === e ? i(t[e]) : parseInt(t[e], 10));
                return t
            }
        }, {}],
        17: [function(t, e, n) {
        ...
        18: [function(t, e, n) {
            ...
            function o(t, e, n) {
                var i = t;
                return l(e) ? (n = e, "string" == typeof t && (i = {
                    uri: t
                })) : i = d(e, {
                    uri: t
                }), i.callback = n, i
                ...
                function a() {
                    if (!p) {
                        ...
                        0 !== e ? (i = {
                            ...
                            url: E,
                            rawRequest: l
                        }, l.getAllResponseHeaders && (i.headers = u(l.getAllResponseHeaders()))) : o = new Error("Internal XMLHttpRequest Error"), s(o, i, i.body)
                    }
                }
                var s = t.callback;
            ...
            e.exports = r, r.XMLHttpRequest = h.XMLHttpRequest || s, r.XDomainRequest = "withCredentials" in new r.XMLHttpRequest ? r.XMLHttpRequest : h.XDomainRequest,
                function(t, e) {
                    ...
                    r["delete" === t ? "del" : t] = function(e, n, i) {
        ...
        22: [function(t, e, n) {
            function i(t, e, n) {
                ...
                arguments.length < 3 && (n = this), "[object Array]" === h.call(t) ? o(t, e, n) : "string" == typeof t ? r(t, e, n) : a(t, e, n)
            }

            function o(t, e, n) {
                for (var i = 0, o = t.length; i < o; i++) c.call(t, i) && e.call(n, t[i], i, t)
            }
            ...
            function a(t, e, n) {
                for (var i in t) c.call(t, i) && e.call(n, t[i], i, t)
            }
            var s = t("is-function");
            e.exports = i;
        ...
        26: [function(t, e, n) {
            ...
            e.exports = Object.assign || function(t, e) {
                for (var n, a, s = i(t), h = 1; h < arguments.length; h++) {
                    n = Object(arguments[h]);
                    for (var c in n) o.call(n, c) && (s[c] = n[c]);
                    if (Object.getOwnPropertySymbols) {
                        a = Object.getOwnPropertySymbols(n);
                        for (var l = 0; l < a.length; l++) r.call(n, a[l]) && (s[a[l]] = n[a[l]])
                    }
                }
                return s
            }
        ...
        27: [function(t, e, n) {
            ...
            e.exports = function(t, e) {
                ...
                for (var n = "string" == typeof e.type ? e.type : "uint16", h = "number" == typeof e.count ? e.count : 1, c = e.start || 0, l = !1 !== e.clockwise ? a : s, u = l[0], d = l[1], p = l[2], f = 6 * h, E = t || new(i(n))(f), m = 0, v = 0; m < f; m += 6, v += 4) {
                    var g = m + c;
        ...
        31: [function(t, e, n) {
            function i(t, e, n, i) {
                "number" != typeof n && (n = 1), "number" != typeof i && (i = "uint16");
            ...
            function o(t, e, n, i, o) {
                if ("number" != typeof i && (i = 3), "number" != typeof o && (o = "float32"), Array.isArray(n) && Array.isArray(n[0]) && n[0].length !== i) throw new Error("Nested vertex array has unexpected size; expected " + i + " but found " + n[0].length);
            ...
            function r(t, e, n, i) {
                return e = e || [], !t || a(t, e, n) ? (e = s(e, i), t = new THREE.BufferAttribute(e, n), t.needsUpdate = !0, t) : (s(e, t.array), t.needsUpdate = !0, null)
            }

            function a(t, e, n) {
                if (t.itemSize !== n) return !0;
                if (!t.array) return !0;
                var i = t.array.length;
                return Array.isArray(e) && Array.isArray(e[0]) ? i !== e.length * n : i !== e.length
            }
            var s = t("flatten-vertex-data");
            e.exports.attr = o, e.exports.index = i
        }, {
        ...
        32: [function(t, e, n) {
            function i(t, e, n) {
                ...
                if (n = 0 | +(n || 0), Array.isArray(t) && Array.isArray(t[0])) {
                    var i = t[0].length,
                        r = t.length * i;
                    e && "string" != typeof e || (e = new(o(e || "float32"))(r + n));
                    var a = e.length - n;
                    if (r !== a) throw new Error("source length " + r + " (" + i + "x" + t.length + ") does not match destination length " + a);
                    for (var s = 0, h = n; s < t.length; s++)
                        for (var c = 0; c < i; c++) e[h++] = t[s][c]
                } else if (e && "string" != typeof e) e.set(t, n);
                else {
                    var l = o(e || "float32");
                    0 === n ? e = new l(t) : (e = new l(t.length + n), e.set(t, n))
                }
                return e
            }
            var o = t("dtype");
        ...
        34: [function(t, e, n) {
            ...
            e.exports = function(t) {
                ...
                var e = "number" == typeof t.opacity ? t.opacity : 1,
                    ...
                    r = t.color,
                    a = t.map;
                return delete t.map, delete t.color, delete t.precision, delete t.opacity, i({
                    uniforms: {
                        opacity: {
                            type: "f",
                            value: e
        ...
        36: [function(t, e, n) {
            var i = t("../"),
                o = t("../shaders/sdf");
            PANOLENS && PANOLENS.Utils && PANOLENS.SpriteText && (PANOLENS.Utils.loadBMFont = function(e, n) {
                t("./load")(e, PANOLENS.SpriteText.prototype.setBMFont.bind(PANOLENS.SpriteText.prototype, n))
            }, PANOLENS.SpriteText.prototype.generateTextGeometry = i, PANOLENS.SpriteText.prototype.generateSDFShader = o)
        }, {
            "../": 1,
            "../shaders/sdf": 34,
            "./load": 35
        ...
        37: [function(t, e, n) {
            (function(e) {
                ...
                function a(t, e, n) {
                    return "string" == typeof n && "" !== n || (n = "utf8"), t = f(t, 0 | v(e, n)), t.write(e, n), t
                }
                ...
                function h(t, e) {
                    var n = 0 | E(e.length);
                    return t = f(t, n), e.copy(t, 0, 0, n), t
                }
                ...
                function p(t, e) {
                    var n, i = 0;
                    "Buffer" === e.type && Q(e.data) && (n = e.data, i = 0 | E(n.length)), t = f(t, i);
                    for (var o = 0; o < i; o += 1) t[o] = 255 & n[o];
                    return t
                }
                ...
                function g(t, e, n) {
                    var i = !1;
                    if (e |= 0, n = void 0 === n || n === 1 / 0 ? this.length : 0 | n, t || (t = "utf8"), e < 0 && (e = 0), n > this.length && (n = this.length), n <= e) return "";
                    for (;;) switch (t) {
                        case "hex":
                            return x(this, e, n);
                        case "utf8":
                ...
                function S(t) {
                    ...
                    for (var n = "", i = 0; i < e;) n += String.fromCharCode.apply(String, t.slice(i, i += K));
                    return n
                }
                ...
                function _(t, e, n, i, o) {
                    return o || V(t, e, n, 4, 3.4028234663852886e38, -3.4028234663852886e38), G.write(t, e, n, i, 23, 4), n + 4
                }

                function U(t, e, n, i, o) {
                    return o || V(t, e, n, 8, 1.7976931348623157e308, -1.7976931348623157e308), G.write(t, e, n, i, 52, 8), n + 8
                }

                function k(t) {
                    if (t = j(t).replace(J, ""), t.length < 2) return "";
                    for (; t.length % 4 != 0;) t += "=";
                    return t
                }
                ...
                o.TYPED_ARRAY_SUPPORT = void 0 !== e.TYPED_ARRAY_SUPPORT ? e.TYPED_ARRAY_SUPPORT : function() {
                    ...
                    if (t === e) return 0;
                    for (var n = t.length, i = e.length, r = 0, a = Math.min(n, i); r < a && t[r] === e[r];) ++r;
                    return r !== a && (n = t[r], i = e[r]), n < i ? -1 : i < n ? 1 : 0
                    ...
                    else if (isFinite(e)) e |= 0, isFinite(n) ? (n |= 0, void 0 === i && (i = "utf8")) : (i = n, n = void 0);
                    else {
                        var o = i;
                        i = e, e = 0 | n, n = o
                    }
                ...
                o.prototype.slice = function(t, e) {
                    ...
                    t = +t, e |= 0, n |= 0, i || C(this, t, e, n, Math.pow(2, 8 * n), 0);
                    var o = 1,
                        r = 0;
                    ...
                    return t = +t, e |= 0, n || C(this, t, e, 2, 65535, 0), o.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8) : H(this, t, e, !0), e + 2
                }, o.prototype.writeUInt16BE = function(t, e, n) {
                    return t = +t, e |= 0, n || C(this, t, e, 2, 65535, 0), o.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 8, this[e + 1] = 255 & t) : H(this, t, e, !1), e + 2
                }, o.prototype.writeUInt32LE = function(t, e, n) {
                    return t = +t, e |= 0, n || C(this, t, e, 4, 4294967295, 0), o.TYPED_ARRAY_SUPPORT ? (this[e + 3] = t >>> 24, this[e + 2] = t >>> 16, this[e + 1] = t >>> 8, this[e] = 255 & t) : D(this, t, e, !0), e + 4
                }, o.prototype.writeUInt32BE = function(t, e, n) {
                    return t = +t, e |= 0, n || C(this, t, e, 4, 4294967295, 0), o.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : D(this, t, e, !1), e + 4
                    ...
                    var r = 0,
                        a = 1,
                        s = t < 0 ? 1 : 0;
                    for (this[e] = 255 & t; ++r < n && (a *= 256);) this[e + r] = (t / a >> 0) - s & 255;
                    return e + n
                    ...
                    return t = +t, e |= 0, n || C(this, t, e, 2, 32767, -32768), o.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8) : H(this, t, e, !0), e + 2
                }, o.prototype.writeInt16BE = function(t, e, n) {
                    return t = +t, e |= 0, n || C(this, t, e, 2, 32767, -32768), o.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 8, this[e + 1] = 255 & t) : H(this, t, e, !1), e + 2
                }, o.prototype.writeInt32LE = function(t, e, n) {
                    return t = +t, e |= 0, n || C(this, t, e, 4, 2147483647, -2147483648), o.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8, this[e + 2] = t >>> 16, this[e + 3] = t >>> 24) : D(this, t, e, !0), e + 4
                }, o.prototype.writeInt32BE = function(t, e, n) {
                    return t = +t, e |= 0, n || C(this, t, e, 4, 2147483647, -2147483648), t < 0 && (t = 4294967295 + t + 1), o.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : D(this, t, e, !1), e + 4
        ...
        38: [function(t, e, n) {
            ! function(t) {
                ...
                function n(t) {
                    ...
                    var u = 0;
                    for (i = 0, o = 0; i < a; i += 4, o += 3) s = e(t.charAt(i)) << 18 | e(t.charAt(i + 1)) << 12 | e(t.charAt(i + 2)) << 6 | e(t.charAt(i + 3)), n((16711680 & s) >> 16), n((65280 & s) >> 8), n(255 & s);
                    return 2 === h ? (s = e(t.charAt(i)) << 2 | e(t.charAt(i + 1)) >> 4, n(255 & s)) : 1 === h && (s = e(t.charAt(i)) << 10 | e(t.charAt(i + 1)) << 4 | e(t.charAt(i + 2)) >> 2, n(s >> 8 & 255), n(255 & s)), c
                }
                ...
                function i(t) {
                    ...
                    var n, i, r, a = t.length % 3,
                        s = "";
                    for (n = 0, r = t.length - a; n < r; n += 3) i = (t[n] << 16) + (t[n + 1] << 8) + t[n + 2], s += function(t) {
        ...
        39: [function(t, e, n) {
            n.read = function(t, e, n, i, o) {
                ...
                for (a = r & (1 << -l) - 1, r >>= -l, l += i; l > 0; a = 256 * a + t[e + u], u += d, l -= 8);
                if (0 === r) r = 1 - c;
                else {
                ...
                var a, s, h, c = 8 * r - o - 1,
                    ...
                    f = i ? 1 : -1,
                    E = e < 0 || 0 === e && 1 / e < 0 ? 1 : 0;
                for (e = Math.abs(e), isNaN(e) || e === 1 / 0 ? (s = isNaN(e) ? 1 : 0, a = l) : (a = Math.floor(Math.log(e) / Math.LN2), e * (h = Math.pow(2, -a)) < 1 && (a--, h *= 2), e += a + u >= 1 ? d / h : d * Math.pow(2, 1 - u), e * h >= 2 && (a++, h /= 2), a + u >= l ? (s = 0, a = l) : a + u >= 1 ? (s = (e * h - 1) * Math.pow(2, o), a += u) : (s = e * Math.pow(2, u - 1) * Math.pow(2, o), a = 0)); o >= 8; t[n + p] = 255 & s, p += f, s /= 256, o -= 8);
                for (a = a << o | s, c += o; c > 0; t[n + p] = 255 & a, p += f, a /= 256, c -= 8);
                t[n + p - f] |= 128 * E
            }
        }, {}],
        40: [function(t, e, n) {
